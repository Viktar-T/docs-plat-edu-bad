# Phase 2: Cloud Infrastructure & Data Handling - In Progress

## Overview

Cloud infrastructure setup for processing, storing, and managing renewable energy data using Node-RED, MQTT Broker (Eclipse Mosquitto), InfluxDB, Grafana, and Docker Compose. This MVP architecture demonstrates a containerized IoT data pipeline for educational and research purposes, deployed on VPS. All sensor data is simulated, and the stack is fully orchestrated with Docker Compose for easy setup and reproducibility.
